    ...
    <nav class=" navbar navbar-expand-lg navbar-dark bg-dark">
      ...
      <div class="collapse navbar-collapse" id="mybutton">
        ...
        <ul class="navbar-nav  ml-auto">
          <li class="nav-item">
            <a class=" nav-link " href="login.php"><button type="button" class=" bgbutton btn btn-dark btn-lg download-button">Login/Sign up</button></a>
          </li>
        </ul>
      </div>
    </nav>
      ...
      <center>
        <div class="row">
          ...
          <div class="container-fluid  col-lg-6 col-sm-3">
            <a href="login.php "><button type="button " class="btn btn-dark btn-lg download-button"><i class="fas fa-book-open"></i> Book Now <i class="fas fa-arrow-right"></i></button></a>
          </div>
        </div>
      </center>
    </div>
